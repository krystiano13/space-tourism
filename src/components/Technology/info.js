...
/**
 *
 * @type {[{img: {}, alt: string, id: number, title: string, desc: string},{img: {}, alt: string, id: number, title: string, desc: string},{img: {}, alt: string, id: number, title: string, desc: string}]}
 */
export const info = [
    {
        id: 0,
